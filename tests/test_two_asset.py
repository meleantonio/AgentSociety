...
class TestEGMSolverTwoAsset:
    ...
    # NOTE: Tests for _golden_section_search, _build_deposit_grid, and
    # _interpolate_two_asset_policy removed — these internal methods were
    # planned but not yet merged into the EGMSolver implementation.
